...
class RegisterPassword extends StatefulWidget {
  const RegisterPassword({ Key? key, required this.photo, required this.email, required this.name, required this.phone, required this.gender }) : super(key: key);
  final XFile photo;
  final String email;
  final String name;
  final String phone;
                        ...
                        onTap: ()async {
                          if(_keyForm.currentState!.validate()) {
                            ...
                            if(_isPasswordEightCharacters && _hasPasswordOneNumber && _isPasswordIdentic){
                              ...
                              Navigator.push(context, MaterialPageRoute(builder: (context) => RegisterProfileSelect(gender: widget.gender,name: widget.name,email:widget.email ,phone:widget.phone ,photo:widget.photo,password: passv,birthDate: "", )));
