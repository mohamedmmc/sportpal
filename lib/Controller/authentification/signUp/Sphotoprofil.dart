...
class RegisterPhotoprofil extends StatefulWidget {
  const RegisterPhotoprofil({Key? key, required this.email, required this.name, required this.gender, required this.phone}) : super(key: key);
  final String email;
  final String name;
  final String gender;
  final String phone;
          ...
          Padding(padding: const EdgeInsets.fromLTRB(30, 50, 0, 0)
            ,child: Text(
              ...
              Center(
                child: InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => RegisterPassword(name: widget.name,gender: widget.gender,email: widget.email,phone: widget.phone,photo: image!)));
                  },
                  child: Container(
