...
import 'package:sportpal/Controller/screens/home2/HomeFilter.dart';
import 'package:sportpal/Controller/screens/home2/HomeProfil.dart';
import 'package:sportpal/Controller/screens/home2/HomeTeam.dart';
        ...
        clipBehavior: Clip.none, children: [
          ...
          Center(
            ...
            child: FloatingActionButton(backgroundColor: Colors.orange, child: Icon(Icons.shopping_basket), elevation: 0.1, onPressed: () {
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => TennisPlayerTinderScreen()));
            }),
          ),
          Container(
            width: size.width,
            ...
            child: Row(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => HomePageProfil()));
                    setBottomBarIndex(0);
                  },
                ...
                IconButton(
                    ...
                    onPressed: () {
                      setBottomBarIndex(1);
                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => HomePageFilter()));
                ...
                IconButton(
                    ...
                    onPressed: () {
                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => HomePageTeam()));
                      setBottomBarIndex(2);
                    }),
                IconButton(
                    icon: Icon(
